...
INSERT INTO `baskets` (`id`, `name`, `desc`, `image`, `type`, `sell_price`, `active`, `stock`, `user_id`, `category_id`, `discount_id`, `created_at`, `updated_at`) VALUES
(2, 'Couscous panier', NULL, '/img/product-img/basket.jpg', 'fixed', 250, 1, 5, NULL, 5, NULL, '2022-04-19 22:35:35', NULL),
(3, "El Hassnaoui\'s basket", NULL, NULL, 'custom', NULL, 1, NULL, 1, 5, NULL, '2022-04-27 22:45:30', '2022-04-27 22:45:30');
